...
import base64
from mesajlar.mesaj import salam, necesen, sagol, getdim, geldim, neonsahib, ban, emoji1, emoji2, fed, niye, ne, hay, mal, can, balam, xos, hara, gel, gordum, tgtema, mahnı botu, proqramist, bot,
